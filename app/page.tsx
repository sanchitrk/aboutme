          ...
          <div className="space-y-16">
            ...
            <div className="space-y-12">
              {[
                {
                  year: "2021",
                  role: "Backend Engineer/Founding Member",
                  company: "Rigi",
                  description:
                    "Built multi channel communities platform for creators to monetize content. Led development of Telegram communities platform driving 90% revenue jump. Architected near realtime analytics dashboard for creators.",
                  tech: ["Python", "GraphQL", "Redis", "MongoDB"],
                },
                {
                  year: "2021",
                  role: "Tech Lead",
                  company: "Voosh (YC 21)",
                  description:
                    "Lead & built multiple lean MVPs for Product Market Fit. Introduced agile development practices and participated in initial team building & hiring. Mentored engineers on iterative development process.",
                  tech: ["JavaScript", "NodeJS", "AWS"],
                },
                {
                  year: "2019",
                  ...
                  company: "Licious",
                  description:
                    "Built initial data team working with sales & marketing. Created recommendation engine, market basket analysis platform, and customer segmentation based on RFM scores & cohort analysis.",
                ...
                },
                {
                  ...
                  company: "Moneybloom",
                  description:
                    "Designed database schema for mutual funds data management. Built mutual fund distribution platform for banks. Improved platform reliability and reduced downtimes by 30%.",
                  tech: ["PostgreSQL", "AWS", "Django"],
                },
                {
                  year: "2016",
                  role: "Full Stack Developer/Founding Member",
                  company: "Honey Badger Labs",
                  description:
                    "Built EagleOwl restaurant SaaS platform. Worked closely with customers to understand problems. Focused on customer usability & simplicity - made product PMF ready.",
                  tech: ["JavaScript", "Flask", "Linux"],
                },
              ].map((job, index) => (
                <div
                  key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="mailto:sanchitrrk@gmail.com"
                    className="group flex items-center gap-3 text-foreground hover:text-muted-foreground transition-colors duration-300"
                  >
                    <span className="text-lg">sanchitrrk@gmail.com</span>
                    <svg
